...
public class FormDataHandler extends HandlerMiddleware {
    private HttpHandler innerHandler;

    public FormDataHandler(HttpHandler handler) {
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if (contentType != null && contentType.startsWith("multipart/form-data")) {
            ...
            httpExchange.setAttribute("files", list);
            this.innerHandler.handle(httpExchange);
        } else {
            this.innerHandler.handle(httpExchange);
        }
    }
